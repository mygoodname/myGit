...
public class HorizontalProgressView extends ProgressBar {
  ...
  private int mTextSize = Utils.sp2px(getContext(), 9);
  private int mTextColor = Color.parseColor("#ffffff");
  private int mTextOffset = Utils.dp2px(getContext(), 6);
  private int mTextBgHight=Utils.dp2px(getContext(),15);
  private int mTextBgwith=Utils.dp2px(getContext(),65);
  private int mProgressPosition = CENTRE;
  private boolean mTextVisible = true;
  private float mTextSkewX;
  private String mTextPrefix = "";
  private String mTextMiddle = "/";
  private String mTextSuffix = "100";
  ...
  protected void initPaint() {
    ...
    mTextBgPaint.setColor(mReachBarColor);
  ...
  private void drawHorizontalProgressView(Canvas canvas) {
    ...
    float textWidth = 0;
    String text = getProgress()+mTextMiddle + mTextSuffix;
    if (mTextVisible) {
...
//    float progressPosX = (int) (mDrawWidth - textWidth) * (radio);
    float progressPosX = (int) (mDrawWidth - mTextBgwith) * (radio);

    if (progressPosX + mTextBgwith >= mDrawWidth) {
      progressPosX = mDrawWidth - mTextBgwith;
...
//    float endX = progressPosX - mTextOffset / 2;
    ...
    canvas.drawRoundRect(new RectF(progressPosX,mTextBgHight/2,progressPosX+mTextBgwith,-mTextBgHight/2),20,20,mTextBgPaint);
    switch (mProgressPosition) {
      ...
      case TOP: // TOP
        ...
        break;
      default: // CENTER
        canvas.drawText(text, progressPosX+(mTextBgwith/2-textWidth/2), -textHeight, mTextPaint);
        break;
    }
  }
