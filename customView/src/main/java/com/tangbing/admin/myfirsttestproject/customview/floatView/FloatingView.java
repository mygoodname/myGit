...
public class FloatingView implements IFloatingView {
   ...
   /*public void hideImage(){
        if(mEnFloatingView!=null&&mEnFloatingView.floatLayout!=null){
            mEnFloatingView.floatLayout.setVisibility(View.GONE);
        }
   }
   public void showImage(){
       if(mEnFloatingView!=null&&mEnFloatingView.floatLayout!=null){
           mEnFloatingView.floatLayout.setVisibility(View.VISIBLE);
       }
   }*/
    ...
    public void startAnimal(){
        if (mEnFloatingView != null) {
            mEnFloatingView.startRotate();
        }
    }
    public void stopAnimal(){
        if (mEnFloatingView != null) {
            mEnFloatingView.stopRotate();
        }
    }
    public boolean isAnimationing(){
        if (mEnFloatingView != null) {
           return mEnFloatingView.isAnimationing();
        }
        return false;
    }
    public void setImageUrl(String url){
        if (mEnFloatingView != null) {
//            mEnFloatingView.setImageUrl(url);
        }
    }
    @Override
