...
/**
 * Created by tangb on 2019/5/13.
 */

public class MyAudioStyleView extends View {
    // 音频矩形的数量
    ...
    public MyAudioStyleView(Context context) {
        super(context);
    }

    public MyAudioStyleView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        setPaint(context, attrs);
    }

    public MyAudioStyleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setPaint(context, attrs);
    }
